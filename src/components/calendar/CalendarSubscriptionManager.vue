    ...
    <q-card-section>
      ...
      <div class="row q-col-gutter-md q-mb-lg">
        ...
        <div class="col-12 col-sm-6">
          <q-checkbox v-model="filterOptions.rsvpOnly" :label="$t('calendar.subscription.rsvpOnly')" color="primary" />
        ...
        <!-- Interest Filter -->
        <div class="col-12 col-sm-6">
          <q-checkbox v-model="filterOptions.interestedOnly" :label="$t('calendar.subscription.interestedOnly')"
            color="primary" />
          <div class="text-caption text-grey-6 q-ml-lg">
      ...
      <div class="text-center q-mb-md">
        <q-btn color="primary" :label="$t('calendar.subscription.generate')" @click="generateFeed" :loading="loading"
          :disable="!currentPlayer" icon="mdi-calendar-sync" unelevated class="q-px-xl" />
      </div>
      ...
      <div v-if="showPreview" class="q-mt-lg">
        ...
        <div class="row q-gutter-sm justify-center">
          ...
          <q-btn color="accent" label="Copy Data URI" @click="copyDataUri" icon="mdi-calendar-import" outline />
          <q-btn color="primary" :label="$t('calendar.subscription.copyUrl')" @click="copyFeedUrl" icon="mdi-link"
            outline />
        </div>
