                ...
                <div class="q-gutter-md">
                    ...
                    <q-card flat bordered>
                        <q-card-section class="row items-center q-gutter-md">
                            ...
                            <q-btn color="red" outline :label="$t('calendar.subscription.google.action')"
                                icon="mdi-plus" @click="subscribeToGoogle" />
                        </q-card-section>
                    </q-card>
                    ...
                    <q-card flat bordered>
                        <q-card-section class="row items-center q-gutter-md">
                            ...
                            <q-btn color="blue" outline :label="$t('calendar.subscription.outlook.action')"
                                icon="mdi-plus" @click="subscribeToOutlook" />
                        </q-card-section>
                    </q-card>
                    ...
                    <q-card flat bordered>
                        <q-card-section class="row items-center q-gutter-md">
                            ...
                            <q-btn color="grey-8" outline :label="$t('calendar.subscription.apple.action')"
                                icon="mdi-plus" @click="subscribeToApple" />
                        </q-card-section>
                    </q-card>
                    ...
                    <q-card flat bordered>
                        <q-card-section class="row items-center q-gutter-md">
                            ...
                            <q-btn color="green" outline :label="$t('calendar.subscription.other.action')"
                                icon="mdi-content-copy" @click="copyCalendarUrl" :loading="copying" />
                        </q-card-section>
                    </q-card>
                </div>
                            ...
                            <div class="q-mb-md">
                                ...
                                <q-input :model-value="publicCalendarUrl" readonly outlined dense class="q-mb-sm">
                                    <template v-slot:append>
                                        <q-btn icon="mdi-content-copy" flat round size="sm" @click="copyCalendarUrl"
                                            :loading="copying" />
                                    </template>
                                </q-input>
                            </div>
