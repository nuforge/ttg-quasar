          ...
          <div class="row q-gutter-md">
            <div class="col">
              <q-input
                ...
                outlined
                dense
                :rules="[val => !!val || 'Game title is required']"
                lazy-rules
              />
            </div>
            <div class="col">
          ...
          <div class="row q-gutter-md">
            <div class="col">
              <q-input
                ...
                label="BoardGameGeek Link"
                outlined
                dense
                hint="Optional - Link to BoardGameGeek page"
                type="url"
              />
            </div>
            <div class="col">
              <q-input
                ...
                outlined
                dense
                hint="Optional - Link to game image"
                type="url"
              />
            </div>
          </div>
...
const submitGame = async () => {
  ...
  try {
    ...
    await gameSubmissionsStore.submitGame(submissionData);
