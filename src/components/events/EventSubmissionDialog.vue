                ...
                <q-form @submit="submitEvent" class="q-gutter-md">
                    ...
                    <div class="row q-gutter-md">
                        ...
                        <div class="col-12 col-md-4">
                            <q-select v-model="eventData.eventType" :options="eventTypeOptions" label="Event Type *"
                                outlined emit-value map-options :rules="[val => !!val || 'Event type is required']" />
                        </div>
                    </div>
                    ...
                    <div class="row q-gutter-md">
                        <div class="col-12 col-md-4">
                            <q-input :model-value="minPlayersValue"
                                @update:model-value="val => minPlayersValue = val?.toString() || ''" label="Min Players"
                                outlined type="number" min="1" />
                        </div>
                        <div class="col-12 col-md-4">
                            <q-input :model-value="maxPlayersValue"
                                @update:model-value="val => maxPlayersValue = val?.toString() || ''" label="Max Players"
                                outlined type="number" min="1" />
                        </div>
                        <div class="col-12 col-md-4">
                    ...
                    <div v-if="eventData.eventType === 'game_night' || eventData.eventType === 'tournament'"
                        ...
                        <div class="col-12 col-md-6">
                            <q-input v-model="eventData.gameName" label="Game Name" outlined
                                placeholder="e.g., Catan, D&D, Poker" />
                        </div>
                        <div class="col-12 col-md-6">
                            <q-input :model-value="gameIdValue"
                                @update:model-value="val => gameIdValue = val?.toString() || ''"
                                label="Game ID (optional)" outlined type="number"
                                placeholder="Reference ID if applicable" />
                        </div>
                    </div>
                    ...
                    <div class="row q-gutter-md">
                        <div class="col-12 col-md-6">
                            <q-input :model-value="contactEmailValue"
                                @update:model-value="val => contactEmailValue = val?.toString() || ''"
                                label="Contact Email" outlined type="email"
                                :placeholder="currentUser?.email || 'your-email@example.com'" />
                        </div>
                        <div class="col-12 col-md-6">
                            <q-input :model-value="contactPhoneValue"
                                @update:model-value="val => contactPhoneValue = val?.toString() || ''"
                                label="Contact Phone" outlined placeholder="(555) 123-4567" />
                        </div>
                    </div>
                    ...
                    <div class="row items-center">
                        ...
                        <q-input v-if="isRecurringValue" :model-value="recurringPatternValue"
                            @update:model-value="val => recurringPatternValue = val?.toString() || ''" label="Pattern"
                            outlined placeholder="e.g., weekly, monthly, bi-weekly" class="q-ml-md" style="flex: 1" />
                    </div>
