    ...
    <div class="game-list">
        ...
        <div class="list-header q-mb-md" v-if="showControls">
            <div class="row items-center justify-between">
                <div class="text-h6">
                    {{ title }}
                    <q-chip v-if="displayedGames.length !== games.length"
                        :label="displayedGames.length + ' / ' + games.length" color="primary" text-color="white"
                    ...
                    <q-card-section>
                        <div class="row q-gutter-md">
                            ...
                            <div class="col-12 col-sm-6 col-md-3">
                                <q-select v-model="filters.genre" :options="genreOptions" label="Genre" outlined dense
                                    clearable />
                            </div>

                            <!-- Player Count Filter -->
                            <div class="col-12 col-sm-6 col-md-3">
                                <q-select v-model="filters.playerCount" :options="playerCountOptions"
                                    label="Player Count" outlined dense clearable />
                            </div>

                            <!-- Play Time Filter -->
                            <div class="col-12 col-sm-6 col-md-3">
                                <q-select v-model="filters.playTime" :options="playTimeOptions" label="Play Time"
        ...
        <div v-else>
            <!-- Card View -->
            <div v-if="viewMode === 'cards'" class="row q-gutter-md">
                ...
                <q-list bordered separator>
                    <q-item v-for="game in displayedGames" :key="game.id" class="q-pa-md">
                        <q-item-section avatar>
                            <q-img :src="getGameImageUrl(game.image, game.title)" style="width: 60px; height: 60px;"
                                fit="cover"
