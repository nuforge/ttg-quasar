            ...
            <q-card bordered class="q-pa-lg">
                <q-card-section>
                    ...
                    <div class="q-gutter-sm q-mb-lg">
                        <q-btn @click="signInWithGoogle" :loading="loading" unelevated size="lg" class="full-width"
                            color="white" text-color="black" icon="mdi-google" label="Sign in with Google" />
                        <q-btn @click="signInWithFacebook" :loading="loading" unelevated size="lg" class="full-width"
                            color="indigo-7" icon="mdi-facebook" label="Sign in with Facebook" />
                    </div>
                    ...
                    <q-form @submit="signInWithEmail" class="q-gutter-md">
                        <q-input v-model="email" filled type="email" label="Email" lazy-rules :rules="[
                        ...
                        <q-input v-model="password" filled :type="showPassword ? 'text' : 'password'" label="Password"
                    ...
                    <div class="text-center">
                        ...
                        <q-btn @click="showSignUp = true" flat color="primary" label="Create Account"
                ...
                <q-card style="min-width: 350px">
                    ...
                    <q-card-section class="q-pt-none">
                        <q-form @submit="signUpWithEmail" class="q-gutter-md">
                            <q-input v-model="signUpData.displayName" filled label="Display Name" lazy-rules
                            ...
                            <q-input v-model="signUpData.email" filled type="email" label="Email" lazy-rules :rules="[
                                (val) => (val && val.length > 0) || 'Please enter your email',
                                (val) => /.+@.+\..+/.test(val) || 'Please enter a valid email',
                            ]">
                                <template v-slot:prepend>
                            ...
                            <q-input v-model="signUpData.password" filled type="password" label="Password" lazy-rules
                                :rules="[
                            ...
                            <q-input v-model="signUpData.confirmPassword" filled type="password"
                    ...
                    <q-card-actions align="right">
                        ...
                        <q-btn unelevated label="Create Account" color="primary" :loading="loading"
