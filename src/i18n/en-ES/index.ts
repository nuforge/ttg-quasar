export default {
  ...
  adminEvents: {
    ...
    tryAdjustingFiltersOrAdd: 'Intenta ajustar tus filtros o agrega un nuevo evento.',
    selectAllEvents: 'Seleccionar todos los eventos',
    editEvent: 'Editar evento',
    cancelEvent: 'Cancelar evento',
    deleteEvent: 'Eliminar evento',
    cancelAll: 'Cancelar Todo',
    cancelAllTitle: 'Cancelar Eventos',
    areYouSureCancel: '¿Estás seguro de que deseas cancelar {count} evento(s)? Se notificará a todos los asistentes.',
    areYouSureDelete: '¿Estás seguro de que deseas eliminar permanentemente {count} evento(s)? Esta acción no se puede deshacer.',
    attendance: 'Asistencia',
    confirmedRsvps: 'Confirmaciones de Asistencia',
    interestedRsvps: 'Interesados',
  },
  ...
  eventForm: {
    createEvent: 'Crear Evento',
    editEvent: 'Editar Evento',
    subtitle: 'Crea una nueva sesión de juego para tu comunidad',
    dateAndTime: 'Fecha y Hora',
    playerCapacity: 'Capacidad de Jugadores',
    organizerNotes: 'Notas del Organizador',
    descriptionHint: 'Describe tu evento, qué esperar y cualquier instrucción especial',
    notesHint: 'Notas internas para organizadores (no visibles para asistentes)',
    syncToCalendar: 'Sincronizar con Google Calendar',
    syncDescription: 'Agregar este evento al Google Calendar de la comunidad',
    ...
    minPlayersError: 'Debe ser al menos 1',
    maxPlayersError: 'Debe ser mayor o igual a jugadores mínimos',
  },
