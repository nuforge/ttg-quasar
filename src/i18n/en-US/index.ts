export default {
  ...
  clca: {
    ...
    notSynced: 'Not synced to newsletter',
  ...
  admin: {
    ...
    clca: {
      title: 'CLCA Integration',
      status: 'CLCA Status',
      healthy: 'Healthy',
      unhealthy: 'Unhealthy',
      eventsSynced: 'Events Synced',
      gamesSynced: 'Games Synced',
      syncFailures: 'Sync Failures',
      dlqItems: 'Queue Items',
      deadLetterQueue: 'Dead Letter Queue',
      readyForRetry: 'Ready for Retry',
      pendingRetry: 'Pending Retry',
      avgAttempts: 'Avg Attempts',
      syncAllEvents: 'Sync All Events',
      syncAllGames: 'Sync All Games',
      processDLQ: 'Process Queue',
      healthCheck: 'Health Check',
      clcaSettings: 'CLCA Settings',
      advancedActions: 'Advanced Actions',
      clearDLQ: 'Clear Queue',
      viewDLQItems: 'View Queue Items',
      bulkSyncComplete: 'Bulk sync completed',
      bulkGameSyncComplete: 'Bulk game sync completed',
      bulkSyncResults: '{success} successful, {errors} failed',
      bulkSyncFailed: 'Bulk sync failed',
      dlqProcessed: 'Queue processed',
      dlqProcessResults: 'Processed {processed}, succeeded {succeeded}, failed {failed}',
      dlqProcessFailed: 'Queue processing failed',
      healthCheckPassed: 'Health check passed',
      healthCheckFailed: 'Health check failed',
      healthCheckError: 'Health check error',
      confirmClearDLQ: 'Clear Dead Letter Queue',
      clearDLQWarning: 'This will permanently delete all queued items. Are you sure?',
      ...
      clcaHealthy: 'CLCA service is healthy and responding',
      clcaUnhealthy: 'CLCA service is unavailable or experiencing issues',
    },
  },
